...
const (
	...
	// EntityID specifies the name of the header which contains the Entity ID of
	// the sender of the payload. This Entity ID can either be:
	// * "cid-<container-id>" or "ci-<container-id>" for the container ID.
	// * "in-<cgroupv2-inode>" for the cgroupv2 inode.
	// It could be extended to support other entities such as the pid.
